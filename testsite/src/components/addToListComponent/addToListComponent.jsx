...
class mapQuest extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Card>
        <Card.Content >
          <Card.Header className="title" onClick={()=>{this.openCloseSwitch()}}>Вопрос {index + 1}: {question} {groupsState && editQuest.group ? "Группа: " + editQuest.group : ""} </Card.Header>
          {this.state.openSw ? <div className="testDiv">
